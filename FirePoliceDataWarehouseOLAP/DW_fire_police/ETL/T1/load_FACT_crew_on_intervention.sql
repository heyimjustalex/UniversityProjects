...
BEGIN
	...
	FROM RDB_fire_police_vsmall_T1.dbo.Notification
	...
	FROM RDB_fire_police_vsmall_T1.dbo.Intervention_type
	...
	--PRINT('name severity');
	--PRINT(@name_intervention_type);
	--PRINT(@severity_intervention_type);
	-- get id in dw_intervention_type of such name and severity
...
--INSERT FROM TEMPORARY TO DW



INSERT INTO DW_fire_police_vsmall.dbo.FACT_crew_on_intervention(
id_intervention_type,
id_vehicle_vin,
id_departure_location,
id_facility_location,
id_date_of_intervention,
id_time_of_intervention,
id_notification,
time_since_notification,
days_intervention_duration,
time_intervention_duration,
number_of_impacted_people,
number_of_dead_people,
success_of_intervention)
SELECT 
id_intervention_type, 
id_veh, 
id_departure_location,
